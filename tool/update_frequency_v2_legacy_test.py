...
Path('test/frequency_probe_session_safety_contract_test.dart').write_text(r'''import 'dart:io';
...
void main() {
  test('native V2 owns camera only after Flutter controller is disposed', () {
    ...
    final end = camera.indexOf('Future<void> _settleCameraAfterLiveProbe', start);
