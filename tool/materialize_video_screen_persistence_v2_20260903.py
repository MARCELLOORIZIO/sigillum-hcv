...
Path('test/build73_video_screen_persistence_v2_regression_test.dart').write_text(r'''import 'package:flutter_test/flutter_test.dart';
...
print('video screen persistence v2 materialized')
