...
var decision = illumination.decision;
    ...
    final reasons = <String>[...illumination.reasons, ...geometry.reasons];    if (strongGeometryReality && rawDisplayEvidence) {
...
final indeterminate =
        decision == 'NON_CONCLUSIVE' && !displayEvidence && !realityEvidence;
