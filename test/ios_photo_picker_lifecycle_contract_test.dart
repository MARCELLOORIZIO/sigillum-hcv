...
void main() {
  test(
    'iOS original-photo picker cannot remain globally busy after selection',
    () {
      ...
      expect(
        scene,
        contains('presenter.presentedViewController is PHPickerViewController'),
      );
      ...
      final takeIndex = delegateBlock.indexOf(
        'takePendingOriginalPhotoResult()',
      );
      final resolveIndex = delegateBlock.indexOf(
        'resolveOriginalPhotoSelection(',
      );
      ...
      expect(
        scene,
        contains(
          'resolveOriginalPhotoSelection(results, result: flutterResult)',
        ),
      );
      expect(
        scene,
